...
$companies = $conn->query('SELECT id, name, created_at FROM companies ORDER BY created_at DESC')->fetch_all(MYSQLI_ASSOC);
...
<div class="panel">
    <table>
        <thead><tr><th>Company</th><th>Signed up</th><th>Score</th><th>Open gaps</th><th>Risk</th></tr></thead>
        <tbody>
        <?php if (!$companies): ?>
            <tr><td colspan="5" class="helper">No companies yet.</td></tr>
        <?php endif; ?>
